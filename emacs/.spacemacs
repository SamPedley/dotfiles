  ...
  (setq-default
   ...
   dotspacemacs-configuration-layers
    '(html
     ...
     multiple-cursors
     treemacs
       (org :variables org-projectile-file "~/Dropbox/Notes/TODOS.org"
